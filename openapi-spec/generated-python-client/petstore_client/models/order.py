...
class Order(BaseModel):
    ...
    pet_id: Optional[StrictInt] = Field(default=None, alias="petId", json_schema_extra={"examples": [198772]})
    quantity: Optional[StrictInt] = Field(default=None, json_schema_extra={"examples": [7]})
    ship_date: Optional[datetime] = Field(default=None, alias="shipDate")
    status: Optional[StrictStr] = Field(default=None, description="Order Status", json_schema_extra={"examples": ["approved"]})
